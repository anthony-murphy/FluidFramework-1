 ...
 * @internal
 */
export function createRemoveRangeOp(start: number, end: number): Fixed<IMergeTreeRemoveMsg> {
	return {
		pos1: start,
		pos2: end,
 ...
 * @internal
 */
export function createInsertOp(pos: number, segSpec: unknown): Fixed<IMergeTreeInsertMsg> {
	return {
		pos1: pos,
		seg: segSpec,
